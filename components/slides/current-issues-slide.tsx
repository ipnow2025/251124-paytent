      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-6 rounded-xl bg-amber-50 border border-amber-200">
            <h3 className="text-xl font-bold text-amber-900 mb-3">연차료 관리에 대한 무관심 사유</h3>
          ...
          <div className="p-6 rounded-xl bg-blue-50 border border-blue-200">
            <h3 className="text-xl font-bold text-blue-900 mb-3">연차료 관리 단계의 중요성</h3>
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <span className="text-blue-600 font-bold text-base">1.</span>
                <p className="text-base text-gray-700">유지되어야 하는 특허권리에 대해서만 납부해야 효율적</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-600 font-bold text-base">2.</span>
                <p className="text-base text-gray-700">유지가 필요한 특허권리는 평가를 통해서 확인 가능</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-600 font-bold text-base">3.</span>
                <p className="text-base text-gray-700">보유특허의 평가는 연차료 납부 시점에 진행되어야 함</p>
              </div>
              <div className="flex items-start gap-2">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="p-6 rounded-xl bg-red-50 border-2 border-red-300">
            ...
            <h4 className="text-xl font-bold text-red-900 mb-2">① 불필요한 비용 발생</h4>
          ...
          <div className="p-6 rounded-xl bg-red-50 border-2 border-red-300">
            ...
            <h4 className="text-xl font-bold text-red-900 mb-2">② 주요 특허 소멸</h4>
            <ul className="space-y-1.5 text-base text-gray-700">
              <li>• 외주업체 관리 미흡</li>
              <li>• 담당자 관리의 한계</li>
          ...
          <div className="p-6 rounded-xl bg-red-50 border-2 border-red-300">
            ...
            <h4 className="text-xl font-bold text-red-900 mb-2">③ 판단 시기 상시</h4>
            <ul className="space-y-1.5 text-base text-gray-700">
