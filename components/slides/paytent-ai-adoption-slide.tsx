  ...
  return (
    <div className="h-full flex flex-col px-12 pb-16 pt-12 bg-background">
      <div className="mb-6">
        ...
        <h2 className="text-[2.75rem] font-bold text-foreground mb-3">Paytent AI 도입 후 변화</h2>
        <p className="text-xl text-muted-foreground">그리고 앞으로의 여정</p>
      </div>

      <div className="flex-1 space-y-6">
        {/* Before vs After */}
        <div>
          <h3 className="text-[1.375rem] font-bold text-foreground mb-4 text-center">Before vs After</h3>
            ...
            {beforeAfter.map((item, index) => (
              <div key={index} className="flex items-center gap-3 p-3 rounded-xl bg-card border border-border">
                <div className="flex-1 p-2.5 rounded-lg bg-muted/50">
                  <p className="text-lg text-muted-foreground">{item.before}</p>
                </div>
                <ArrowRight className="w-5 h-5 text-accent flex-shrink-0" />
                <div className="flex-1 p-2.5 rounded-lg bg-accent/10 border border-accent/30">
                  <p className="text-xl text-foreground font-semibold">{item.after}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 gap-5">
          <div className="p-5 rounded-xl bg-card border border-border">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[1.375rem] font-bold text-foreground">도입 일정</h3>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-2.5 rounded-lg bg-primary/10 border border-primary/20">
                <p className="text-xl font-semibold text-foreground">2026년 상반기</p>
                <p className="text-lg text-muted-foreground">파일럿 고객사 적용</p>
              </div>
              <div className="p-2.5 rounded-lg bg-primary/10 border border-primary/20">
                <p className="text-xl font-semibold text-foreground">2026년 하반기</p>
                <p className="text-lg text-muted-foreground">정식 오픈 및 기능 확장</p>
              </div>
            </div>
          </div>
        </div>
