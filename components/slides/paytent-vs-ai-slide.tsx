        ...
        <div className="flex flex-col">
          <div className="mb-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-2xl font-bold text-foreground">기존 Paytent가 잘하는 것</h3>
            </div>
        ...
        <div className="flex flex-col">
          <div className="mb-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-2xl font-bold text-foreground">여전히 남아 있던 과제</h3>
            </div>
            <p className="text-base text-muted-foreground">
      ...
      <div className="mt-6 p-6 rounded-2xl bg-gradient-to-r from-primary/10 via-accent/10 to-secondary/10 border-2 border-accent/30">
        <div className="flex items-center justify-center gap-6">
          <div className="text-center">
            <p className="text-base text-muted-foreground mb-2">기존 Paytent 위에</p>
            <div className="flex items-center gap-3">
              <span className="px-4 py-2 rounded-lg bg-primary/20 text-primary font-bold text-sm">덜 챙기기</span>
              <span className="text-xl text-muted-foreground">+</span>
              <span className="px-4 py-2 rounded-lg bg-accent/20 text-accent font-bold text-sm">덜 고민하기</span>
              <span className="text-xl text-muted-foreground">+</span>
              <span className="px-4 py-2 rounded-lg bg-secondary/20 text-secondary font-bold text-sm">덜 찾기</span>
            </div>
          </div>
          <ArrowRight className="w-7 h-7 text-accent" />
          <div className="text-center">
            <p className="text-base text-muted-foreground mb-2">세 가지 AI 레이어</p>
