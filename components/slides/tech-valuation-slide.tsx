    ...
    <div className="h-full flex flex-col p-16 bg-background">
      ...
      <div className="flex-1 grid grid-cols-2 gap-8 min-h-0">
        ...
        <div className="p-6 rounded-xl bg-blue-50 border-2 border-blue-200 flex flex-col">
          <h3 className="text-2xl font-bold text-blue-900 mb-4">특허의 숨겨진 가치를 발견하세요</h3>
          ...
          <div className="space-y-4 flex-1">
            <div className="p-4 rounded-lg bg-white border border-blue-100">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="text-lg font-bold text-blue-900">차별화된 분석 시스템</h4>
              </div>
            ...
            <div className="p-4 rounded-lg bg-white border border-blue-100">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="text-lg font-bold text-blue-900">전문가 집단의 노하우</h4>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white border border-blue-100">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="text-lg font-bold text-blue-900">신뢰할 수 있는 결과</h4>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <div className="p-6 rounded-xl bg-slate-50 border-2 border-slate-200 flex flex-col overflow-hidden">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">기술가치평가보고서</h3>
