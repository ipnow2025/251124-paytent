  ...
  return (
    <div className="h-full flex flex-col p-16 bg-background">
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground">연차료 누락 RISK 0% - 3단계 다중 구조 검증</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="grid grid-cols-3 gap-8 w-full">
          <div className="flex flex-col items-center text-center space-y-6 p-8 rounded-xl bg-card border-2 border-primary/30">
            ...
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-3">1차 Risk 감소</h3>
              <p className="text-lg text-muted-foreground mb-4">시스템 크로스체크</p>
          ...
          <div className="flex flex-col items-center text-center space-y-6 p-8 rounded-xl bg-card border-2 border-primary/30">
            ...
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-3">2차 Risk 감소</h3>
              <p className="text-lg text-muted-foreground mb-4">멀티 크로스체크</p>
              <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="flex flex-col items-center text-center space-y-6 p-8 rounded-xl bg-card border-2 border-primary/30">
            ...
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-3">3차 Risk 감소</h3>
              <p className="text-lg text-muted-foreground mb-4">체크 주기 단축</p>
              <p className="text-sm text-muted-foreground leading-relaxed">
