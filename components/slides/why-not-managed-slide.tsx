  ...
  return (
    <div className="h-full flex flex-col p-16 bg-background">
      ...
      <div className="flex-1 grid grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border-2 border-slate-200 p-8 flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-[1.375rem] font-bold text-slate-800">특허 관리 전문 인력 부재</h3>
          </div>
          <div className="flex-1 flex flex-col justify-between">
            <div className="space-y-3 text-slate-600">
              ...
              <p className="text-lg leading-relaxed">관리 규모·복잡도 대비 담당자 수와 역량이 현저히 부족합니다.</p>
            </div>
        ...
        <div className="bg-white rounded-xl border-2 border-slate-200 p-8 flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-[1.375rem] font-bold text-slate-800">연차료 관리 시스템 부재</h3>
          </div>
          <div className="flex-1 flex flex-col justify-between">
            <div className="space-y-3 text-slate-600">
              <p className="text-lg leading-relaxed">
              ...
              <p className="text-lg leading-relaxed">체계적인 연차료 관리 부재로 인한 권리 상실 위험이 상존합니다.</p>
            </div>
        ...
        <div className="bg-white rounded-xl border-2 border-slate-200 p-8 flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-[1.375rem] font-bold text-slate-800">매출과 무관한 특허</h3>
          </div>
          <div className="flex-1 flex flex-col justify-between">
            <div className="space-y-3 text-slate-600">
              <p className="text-lg leading-relaxed">비용만 쓰고 매출과 무관한 특허만 보유</p>
              <p className="text-lg leading-relaxed">
        ...
        <div className="bg-white rounded-xl border-2 border-slate-200 p-8 flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-[1.375rem] font-bold text-slate-800">권리 행사가 어려운 특허 포트폴리오</h3>
          </div>
          <div className="flex-1 flex flex-col justify-between">
            <div className="space-y-3 text-slate-600">
              <p className="text-lg leading-relaxed">특허권은 있으나 활용가능한 독점권은 확보하기 어려운 구조</p>
              <p className="text-lg leading-relaxed">포트폴리오 전략 부재로 권리 행사의 실효성이 낮습니다.</p>
            </div>
      ...
      <div className="mt-6 p-5 rounded-xl bg-gradient-to-r from-red-600 to-red-700 text-white shadow-lg flex items-center justify-center gap-3">
        ...
        <p className="text-center text-[1.375rem] font-bold">IP 권리유지 의사결정 미흡 → 핵심·우수특허의 반복적 소멸</p>
      </div>
    </div>
  )
}
