      ...
      <div className="flex-1 flex flex-col justify-center gap-4">
        ...
        <div className="p-6 rounded-2xl bg-card border border-border">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h3 className="text-[1.375rem] font-bold text-foreground">현재 위치</h3>
          </div>
          <div className="space-y-2">
            <p className="text-lg text-foreground leading-relaxed">
              {'Paytent는 지금도 국내·해외 연차료를 통합 관리하는 '}
              <span className="font-bold">"연차료 관리 전문 플랫폼"</span>
              {'입니다.'}
            </p>
            <p className="text-lg text-foreground leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-card border border-border">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h3 className="text-[1.375rem] font-bold text-foreground">환경이 바뀌고 있습니다</h3>
          </div>
          <div className="grid grid-cols-3 gap-4">
            <div className="p-3 rounded-lg bg-destructive/5 border border-destructive/20">
              <p className="text-xl font-semibold text-foreground mb-1">특허 포트폴리오 증가</p>
              <p className="text-lg text-muted-foreground">관리 대상이 늘어남</p>
            </div>
            <div className="p-3 rounded-lg bg-destructive/5 border border-destructive/20">
              <p className="text-xl font-semibold text-foreground mb-1">예산 압박 증가</p>
              <p className="text-lg text-muted-foreground">비용 효율화 요구</p>
            </div>
            <div className="p-3 rounded-lg bg-destructive/5 border border-destructive/20">
              <p className="text-xl font-semibold text-foreground mb-1">담당 인원 부족</p>
              <p className="text-lg text-muted-foreground">업무 부담 가중</p>
            </div>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-r from-primary/10 via-accent/10 to-secondary/10 border-2 border-accent/30">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h3 className="text-[1.375rem] font-bold text-foreground">우리가 내린 결론</h3>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="p-3 rounded-lg bg-card border border-primary/30">
                ...
                <p className="text-xl font-semibold text-foreground mb-1">자동화</p>
                <p className="text-lg text-muted-foreground">반복 업무 자동 처리</p>
              </div>
              <div className="p-3 rounded-lg bg-card border border-accent/30">
                <Brain className="w-5 h-5 text-accent mb-1" />
                <p className="text-xl font-semibold text-foreground mb-1">지능화</p>
                <p className="text-lg text-muted-foreground">AI 기반 의사결정 지원</p>
              </div>
              <div className="p-3 rounded-lg bg-card border border-secondary/30">
                <Zap className="w-5 h-5 text-secondary mb-1" />
                <p className="text-xl font-semibold text-foreground mb-1">편리함</p>
                <p className="text-lg text-muted-foreground">사용자 경험 혁신</p>
              </div>
            </div>
